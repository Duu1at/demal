...
MyBookingsModel _$MyBookingsModelFromJson(Map<String, dynamic> json) => MyBookingsModel(
...
Map<String, dynamic> _$MyBookingsModelToJson(MyBookingsModel instance) => <String, dynamic>{
